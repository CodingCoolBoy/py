...
class Config:
    def __init__(self, dataset, model_name, train=True):
        self.dataset = dataset
        self.model_name = model_name
        self.yaml = dataset + "_" + model_name
        yaml_name = './config/%s.yml' % self.yaml
        ...
        self.lr = cfg['lr']
        self.optim_flag = cfg['optim_flag']
        ...
        if self.dataset == '2016.10a':
            ...
            self.classes = {b'8PSK': 0, b'BPSK': 1, b'QPSK': 2, b'QAM16': 3, b'QAM64': 4,
                            b'CPFSK': 5, b'GFSK': 6, b'AM-DSB': 7, b'AM-SSB': 8, b'PAM4': 9,
                            b'WBFM': 10}
        else:
